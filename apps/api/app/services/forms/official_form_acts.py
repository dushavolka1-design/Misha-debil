...
OFFICIAL_FORM_ACTS: dict[str, dict[str, Any]] = {
    "mvd.arrival_notice.app4": {
        ...
        "act_title": (
            "Приказ МВД России от 10.12.2020 N 856 "
            "(ред. Приказа МВД России от 22.10.2024 N 628), приложение N 4"
        ),
    ...
    "mvd.vnz.application": {
        ...
        "act_title": (
            "Приказ МВД России от 11.06.2020 N 417 — административный регламент "

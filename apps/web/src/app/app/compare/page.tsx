  ...
  return (
    <div>
      ...
      <p className="dar-page-lead">
        Diff по сторонам, иерархии разделов и смысловым пунктам (добавлено / удалено / изменено) с
        двумя ссылками на источник. Без оценки «какой выгоднее». Данные другого пользователя не
        подмешиваются.
      </p>
      <ScreenStateView
        state={state}
        ...
        ready={
          <div className="dar-panel">
            <p style={{ margin: 0, color: 'var(--dar-color-text-secondary)' }}>
              Загрузите и проанализируйте документы в разделе «Анализатор», затем вернитесь к
              сравнению.
            </p>
          </div>
        }
